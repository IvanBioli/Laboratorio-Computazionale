%Script per gli esperimenti numerici sul Metodo di Newton Modificato per AVE
N = 1000;
itmax = 100;
m = 100;
omega = 0.7;
...
%MNM: caso 5
mnm_it_5 = zeros(m,1);
mnm_tonvi_5 = 0;              %total numuber of violated instances
mnm_time_5 = zeros(m,1);
mnm_tottime_5 = 0;            %total time
mnm_nonviolatedtime_5 = 0;    %total time for the non violated istances
mnm_totit_5 = 0;              %total number of iterations
mnm_nonviolatedit_5 = 0;      %total number of iterations for the non violated istances
for i = 1:m
    tic;
    [x,it] = MNM_AVE(A5{i}, b5{i}, omega);
    mnm_time_5(i) = toc;
    if (it == itmax)
        mnm_tonvi_5 = mnm_tonvi_5 + 1;
    else
        mnm_nonviolatedtime_5 = mnm_nonviolatedtime_5 + mnm_time_5(i);
        mnm_nonviolatedit_5 = mnm_nonviolatedit_5 + it;
    end
    mnm_it_5(i) = it;    
end
mnm_tottime_5 = sum(mnm_time_5);
mnm_totit_5 = sum(mnm_it_5);